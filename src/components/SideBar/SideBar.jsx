...
export default function SideBar({ sideBarDisplay, sideBarDisplayHandler }) {
    ...
    return (
        <div className={`h-screen group w-80 md:w-16 transition-all md:hover:w-80 flex flex-col shadow-lg bg-second-bg-web-dark ${sideBarDisplay ? "-right-0" : "-right-80"} md:right-0 top-0 z-40 absolute py-6 gap-y-10`}>
