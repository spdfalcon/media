...
export default function TopBar() {
    return (
        <div className="sticky top-0 right-0 left-0 h-20 shadow-lg bg-second-bg-web-dark">
            <div className="container flex justify-between items-center h-full ltr-theme">
                {/* main TopBar */}
                <div className="hidden md:flex items-center gap-x-5 h-full">
                    ...
                    <div className="flex items-center font-iransans h-10 w-80 bg-main-bg-web-dark rounded ml-6 overflow-hidden">
                        <BiSearch className='text-main-gray-text-admin shrink-0 text-xl mx-2' />
                ...
                <div className='bg-main-red-admin/30 p-2 rounded-md cursor-pointer flex md:hidden'>
